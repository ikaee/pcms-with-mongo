...
import {advaya_attendance, fetchAanganwadis, fetchHMRLog, fetchBeneficiaryImage} from "../utils/WebApi";
...
class HMR extends Component {
    ...
    fetchData = (selectedOption,date) => {
      if(selectedOption !== null && selectedOption !== '') {
        axios.get(`/pcms/v1/hotcooked/report/${selectedOption.code}/${date.format("DD-MM-YYYY")}`)
            .then(({data}) => {
                this.setState({
                    loaded: true,
